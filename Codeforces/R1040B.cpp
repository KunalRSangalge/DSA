...
void solve() {
    ...
    if (s < total_sum) {
        bool first = true;
        for (int i = 0; i < count0; ++i) { if (!first) cout << " "; cout << 0; first = false; }
        for (int i = 0; i < count1; ++i) { if (!first) cout << " "; cout << 1; first = false; }
        for (int i = 0; i < count2; ++i) { if (!first) cout << " "; cout << 2; first = false; }
        cout << endl;
    } else if (s == total_sum) {
        cout << -1 << endl;
    } else { 
